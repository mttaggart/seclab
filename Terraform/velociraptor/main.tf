...
resource "proxmox_virtual_environment_vm" "seclab-velociraptor" {
  name      = "Seclab-Velociraptor"
...
output "vm_ip" {
  value       = proxmox_virtual_environment_vm.seclab-velociraptor.ipv4_addresses
  sensitive   = false
  description = "VM IP"
}
