...
resource "proxmox_virtual_environment_vm" "seclab-cryptpad" {
  name      = "Seclab-Cryptpad"
...
output "vm_ip" {
  value       = proxmox_virtual_environment_vm.seclab-cryptpad.ipv4_addresses
  sensitive   = false
  description = "VM IP"
}
